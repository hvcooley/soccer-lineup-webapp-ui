    ...
    {id: 1, date: '2017-09-14', actualStartTime: '2017-09-14, 11:49:36 AM', 
      myTeam: {id: 18, name: 'Delbarton Varsity Soccer 16/17', isFavorite: false, isMyTeam: true, primaryColor: '#032a03', secondaryColor: '#f8f8f8',
        playersGameData: [
          ...
          {playerId: 3, firstName: 'Iago', lastName: 'Robertson-Lavalle', teamId: 11, jerseyNum: 1, position: 'GK', isStarter: true, isOnField: true, goals: 0, assists: 0, circleId: 3, circleXCoord: 400, circleYCoord: 750},
          {playerId: 4, firstName: 'Leo', lastName: 'Cooley', teamId: 11, jerseyNum: 39, position: 'CDM', isStarter: true, isOnField: true, goals: 0, assists: 1, circleId: 4, circleXCoord: 400, circleYCoord: 550},
          {playerId: 5, firstName: 'Steven', lastName: 'Hadley', teamId: 11, jerseyNum: 13, position: 'CAM', isStarter: true, isOnField: true, goals: 1, assists: 0, circleId: 5, circleXCoord: 300, circleYCoord: 500},
          {playerId: 6, firstName: 'Matt', lastName: 'Christou', teamId: 11, jerseyNum: 7, position: 'RB', isStarter: true, isOnField: true, goals: 0, assists: 0, circleId: 6, circleXCoord: 100, circleYCoord: 400},
          {playerId: 7, firstName: 'Sam', lastName: 'Fuchs', teamId: 11, jerseyNum: 5, position: 'CB', isStarter: true, isOnField: true, goals: 0, assists: 0, circleId: 7, circleXCoord: 300, circleYCoord: 650},
